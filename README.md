...
<table>
  <tbody>
    ...
    <tr>
      <td>
        <a href = "https://github.com/TexasInstruments/ble_examples/tree/simplelink_low_power_f3_sdk-8.40">TI SimpleLink Low Power F3 SDK 8.40.00.00</a>
      </td>
      <td>
        <ul>
...
### SimpleLink Low Power F3 SDK Examples 8.40.00.00
